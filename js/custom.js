...
$(document).ready(function() {
  ...
  $(document).ready(function() {
            $('.seller_slider_wrapper .owl-carousel').owlCarousel({
              loop: true,
              margin: 10,
              autoplay: true,
              smartSpeed: 1200,
  ...
  $(document).ready(function() {
            $('.shoses_slider_wrapper .owl-carousel').owlCarousel({
              loop: true,
              margin: 10,
              autoplay: true,
              smartSpeed: 1200,
...
document.getElementById('search-dropdown').addEventListener('click', function() {
...
document.querySelectorAll('.js-search-select').forEach(function(item) {
    item.addEventListener('click', function() {
        document.getElementById('search-dropdown').value = this.textContent;
